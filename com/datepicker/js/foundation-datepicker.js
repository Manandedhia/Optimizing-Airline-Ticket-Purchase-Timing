...
! function($) {
    ...
    var Datepicker = function(element, options) {
        ...
        this.formatText = options.format || this.element.data('date-format') || dates[this.language].format || 'dd/mm/yyyy';
        this.isInline = false;
        ...
        this.leftArrow = options.leftArrow || '<i class="' + this.faCSSprefix + ' ' + this.faCSSprefix + 'fa fa-chevron-left"/>';
        this.rightArrow = options.rightArrow || '<i class="' + this.faCSSprefix + ' ' + this.faCSSprefix + 'fa fa-chevron-right"/>';
