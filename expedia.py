    ...
    for i in range(5):
        try:
            ...
            for i in flight_data['legs'].keys():
                ...
                if flight_info.get("airline") == 'Vistara' or flight_info.get("airline") == 'Air India' or flight_info.get("airline") == 'Jet Airways':
                    if flightline < 5:
                        # print(flightline)
                        ...
                        try:
                            with connection.cursor() as cursor:
                                sql = "INSERT INTO flightDetails (stops, ticket_price, departure, arrival, flight_duration, airline, plane, departure_time,arrival_time, plane_code) VALUES (%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)"
                                cursor.execute(sql, (stops,ticketPrice,departure,arrival,flight_duration,airline,plane,departure_time,arrival_time,plane_code))
                                connection.commit()
                        except Exception as e:
                            print(e)

                        lists.append(flight_info)
                        flightline = flightline + 1
