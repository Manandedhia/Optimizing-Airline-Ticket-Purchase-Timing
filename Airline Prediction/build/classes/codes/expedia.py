                ...
                if flight_info.get("airline") == 'Air India':
                        ...
                        try:
                            with connection.cursor() as cursor:
                                sql = "INSERT INTO flightDetails (departureDate, stops, ticket_price, departure, arrival, flight_duration, airline, plane, departure_time, arrival_time, plane_code) VALUES (%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)"
                                cursor.execute(sql, (date,stops,ticketPrice,departure,arrival,flight_duration,airline,plane,departure_time,arrival_time,plane_code))
                                connection.commit()
